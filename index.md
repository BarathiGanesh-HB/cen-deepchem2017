...
|-------|--------|---------|
|Span <td colspan=3>triple Frameworks: TensorFlow, Theano, Keras, Scikit-learn, Lasagne, nolearn, Programming languages : Python and Java, Packages: Numpy, Scipy, Pandas, Matplotlib, t-SNE, Gensim, [deepchem](https://github.com/deepchem/deepchem), [DragoNN](https://kundajelab.github.io/dragonn/), [deepvariant](https://github.com/google/deepvariant)||
|-------|--------|---------|
